const student = require('../natalia.kovalyova/exam2');
...
describe('Dev-Pro OpenJS - Exam 2', () => {
    ...
    describe('Method init', () => {
        ...
        it('It shouldn\'t change participants if arguments are wrong', () => {
            const participants = project.participants;
            project.init();
            expect(project.participants).toEqual(participants);
        });

        it('It shouldn\'t change pricing if arguments are wrong', () => {
