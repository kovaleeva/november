...
project.prototype.addParticipant = function (participantObject,
                                             callbackFunction,) {
    if (this.isBusy === true) {
        return false;
    }
...
project.prototype.removeParticipant = function (participantObject,
                                                callbackFunction,) {
    if (this.isBusy === true) {
        return false;
    }
...
project.prototype.setPricing = function (participantPriceObject,
                                         callbackFunction,) {
    if (this.isBusy === true) {
        return false;
    }
